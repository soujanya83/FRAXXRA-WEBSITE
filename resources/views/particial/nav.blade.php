    ...
    <div class="th-menu-area text-center">
        ...
        <div class="mobile-logo">
            <a class="icon-masking" href="/"><span data-mask-src="assets/img/logo-small_updated.png"
                    class="mask-icon"></span><img src="assets/img/logo-small_updated.png" style="width:120px;margin-left: 50%;"
                    alt="fraxxra_small"></a>
        </div>
                    ...
                    <div class="col-auto">
                        <div class="header-logo">
                            <a class="icon-masking" href="{{ route('home_page') }}"><img
                                    src="assets/img/logo-small_updated.png" style="width:120px; margin-left: 50%;" alt="fraxxra_small"></a>
                        </div>
                    </div>
                    <div class="col-auto">
                        <nav class="main-menu d-none d-lg-inline-block">
                            <ul>
                                ...
                                {{-- <li class="menu-item-has-children">
                                    <a href="#">Services</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ route('uxuidesigning_page') }}">UX/UI Designing</a></li>
                                        <li><a href="Webdevelopment">Web Development</a></li>
                                    ...
                                    <ul class="mega-menu">
                                        <li>
                                            <ul>
                                                ...
                                                <li><a href="EntertainmentApp">Entertainment App</a></li>
                                                <li><a href="MechanicApp">Mechanic App</a></li>
                                                <li><a href="PharmancyDeliveryApp">Pharmacy Delivery App</a>
                                                </li>
                                                <li><a href="HotelBookingApp">Hotel Booking App</a></li>
